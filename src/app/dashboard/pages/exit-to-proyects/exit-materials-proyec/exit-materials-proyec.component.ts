...
import { AddDetailsExitComponent } from '../../exit-materials/add-details/add-details.component';
...
@Component({
  selector: 'exit-materials-proyec',
  standalone: true,
  imports: [
    CommonModule,ReactiveFormsModule, AddDetailsExitComponent
  ],
  template: `<p>exit-materials-proyec works!</p>`,
  styles: [`
    :host {
      display: block;
    }
...
export class ExitMaterialsProyecComponent { 
