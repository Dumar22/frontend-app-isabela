...
@Component({
  ...
  templateUrl: './add-edit-work-register-post-service.component.html',
  
})
export class AddEditWorkRegisterPostServiceComponent {
  ...
  addWorkRegister() {
    ...
    if (this.id !== '') {
      ...
      this.workRegisterService.saveWorkRegisterPostService(rest)
      .subscribe({
        next: () => {
